...
public class TestMain {
    public static void main(String[] args) {
        ...
        System.out.println("Login Type (customer or restaurant or deliverydriver) : ");
        ...
        switch (type) {
            ...
            case "deliverydriver":
                ...
                deliverydriver.setDriverId("driver123");
                deliverydriver.setDriverName("Dhanush");
                deliverydriver.setDriverMobile("9876512345");
        ...
        if(type.contentEquals("customer")|type.contentEquals("restaurant")) {
        Menu menu = new Menu();
        ...
        if (type.contentEquals("customer")) {
            ...
            System.out.println("\nSelect item (pizza or burger or sandwitch) : ");
            ...
            if(type.contentEquals("customer")|type.contentEquals("deliverydriver")) {
